...
void AlignmentProducer::beginOfJob( const edm::EventSetup& iSetup )
{
  ...
  // std::cout << "AlignmentProducer.cc " << std::endl;
  ...
  // std::cout << "AlignmentProducer.cc made it past TT" << std::endl;
  ...
  // std::cout << "AlignmentProducer.cc: reached create alignables" << std::endl;

  // Create alignable tracker and muon 
  //AR:
  if (doTracker_) {
    theAlignableTracker = new AlignableTracker( &(*theTracker), tTopo );
    // std::cout << "doTracker" << std::endl;
  }

  if (doMuon_) {
     theAlignableMuon = new AlignableMuon( &(*theMuonDT), &(*theMuonCSC) );
    // std::cout << "doMuon" << std::endl;
  }

  if (useExtras_) {
    theAlignableExtras = new AlignableExtras();
    // std::cout << "useExtras" << std::endl;
  }

  // std::cout << "AlignmentProducer.cc: reached create parameter builder" << std::endl;
  ...
  // std::cout << "made it past get parameter for aliParamBuildCfg " << std::endl;

  // std::cout << "&theAlignableMuon: " << &theAlignableMuon << std::endl;
  // std::cout << "&theAlignableTracker: " << &theAlignableTracker << std::endl;
  // std::cout << "&theAlignableExtras: " << &theAlignableExtras << std::endl;
  // std::cout << "&aliParamBuildCfg: " << &aliParamBuildCfg << std::endl;
  ...
  // std::cout << "AlignmentProducer.cc: reached fix alignables if requ." << std::endl;

  // Fix alignables if requested
  if (stNFixAlignables_>0) alignmentParameterBuilder.fixAlignables(stNFixAlignables_);

  // std::cout << "AlignmentProducer.cc: reached get list of alignables" << std::endl;
  ...
  // std::cout << "AlignmentProducer.cc: create alignment parameter store" << std::endl;
  ...
  // std::cout << "AlignmentProducer.cc: reached apply misalignmenet" << std::endl;
  ...
  // std::cout << "AlignmentProducer.cc: reached apply simple misalignmenet" << std::endl;
  ...
  // std::cout << "AlignmentProducer.cc: reached initialise alignment algo" << std::endl;
  ...
  // std::cout << "AlignmentProducer.cc: reached monitor" << std::endl;
  ...
  // std::cout << "AlignmentProducer.cc: made it to the end of beginOfJob()" << std::endl;
...
void AlignmentProducer::createGeometries_( const edm::EventSetup& iSetup )
{
   ...
   if (doMuon_) {
     ...
     // std::cout << "MuonNumberingRecord in AlignmentProducer.cc" << std::endl;
     iSetup.get<MuonNumberingRecord>().get(mdc);
     // std::cout << "Cleared MuonNumberingRecord in AlignmentProducer.cc" << std::endl;
